              ...
              <a-form label-align="left" :label-col="{ span: 10 }">
                <a-form-item label="默认颜色">
                  <t-color-picker
                    ...
                    @update:modelValue="onChangeOptions('color', options.color)"
                    clearable
                  />
                </a-form-item>
                <a-form-item label="画笔填充颜色">
                  <t-color-picker
                    ...
                    format="CSS"
                    :color-modes="['monochrome']"
                    @update:modelValue="onChangeData('penBackground', data.penBackground)"
                    clearable
                  />
                </a-form-item>
                <a-form-item label="背景颜色" name="background">
                  <t-color-picker
                    ...
                    format="CSS"
                    :color-modes="['monochrome']"
                    @update:modelValue="onChangeData('background', data.background)"
                    clearable
                  />
                </a-form-item>
                ...
                <a-form-item label="网格颜色">
                  <t-color-picker
                    ...
                    format="CSS"
                    :color-modes="['monochrome']"
                    @update:modelValue="onChangeData('gridColor', options.gridColor)"
                    clearable
                  />
                </a-form-item>
                ...
                <a-form-item label="标尺颜色">
                  <t-color-picker
                    ...
                    format="CSS"
                    :color-modes="['monochrome']"
                    @update:modelValue="onChangeData('ruleColor', options.ruleColor)"
                    clearable
                  />
                </a-form-item>
