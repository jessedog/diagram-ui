              ...
              <a-collapse-panel :key="2" :forceRender="true" header="样式">
                ...
                <a-form-item label="背景颜色">
                  <t-color-picker
                    ...
                    format="CSS"
                    :color-modes="['monochrome']"
                    @update:modelValue="changeValue('background')"
                    clearable
                  />
                </a-form-item>
                <a-form-item label="字体颜色">
                  <t-color-picker
                    ...
                    format="CSS"
                    :color-modes="['monochrome']"
                    @update:modelValue="changeValue('Textolor')"
                    clearable
                  />
                </a-form-item>
              ...
              <a-collapse-panel :key="3" :forceRender="true" header="文字">
                ...
                <a-form-item label="文字颜色">
                  <t-color-picker
                    ...
                    format="CSS"
                    :color-modes="['monochrome']"
                    @update:modelValue="changeValue('textColor')"
                    clearable
                  />
                </a-form-item>
                ...
                <a-form-item label="浮动文字颜色">
                  <t-color-picker
                    ...
                    format="CSS"
                    :color-modes="['monochrome']"
                    @update:modelValue="changeValue('hoverTextColor')"
                    clearable
                  />
                </a-form-item>
                <a-form-item label="背景颜色">
                  <t-color-picker
                    ...
                    format="CSS"
                    :color-modes="['monochrome']"
                    @update:modelValue="changeValue('textBackground')"
                    clearable
                  />
                </a-form-item>
